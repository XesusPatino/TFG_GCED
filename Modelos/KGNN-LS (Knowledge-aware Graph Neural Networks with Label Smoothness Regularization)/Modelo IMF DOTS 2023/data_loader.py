...
def load_rating(args):
    ...
    # Handle the dot_2023 dataset specifically
    if args.dataset == 'dot_2023':
...
def load_kg(args):
    ...
    # Handle the dot_2023 dataset - create a minimal knowledge graph
    if args.dataset == 'dot_2023':
        print('Creating minimal knowledge graph for dot_2023 dataset...')
        
        # For dot_2023, we'll create a simple identity-based knowledge graph
