...
class EmissionsPerEpochTracker:
    ...
    def end_epoch(self, epoch, loss, auc=None, f1=None, rmse=None):  # Añadir parámetro RMSE
        try:
            epoch_co2 = 0.0
    ...
    def end_training(self, final_auc=None, final_f1=None, final_rmse=None):  # Añadir parámetro final_rmse
        try:
            ...
            # Plot relationships
            self.plot_emissions_vs_metrics(timestamp, final_auc, final_f1, final_rmse)
    ...
    def plot_emissions_vs_metrics(self, timestamp, final_auc=None, final_f1=None, final_rmse=None):
        ...
        try:
            ...
            plt.figure(figsize=(15, 10))  # Hacer más grande para 6 subplots
            ...
            if self.epoch_auc or self.epoch_f1 or self.epoch_rmse:
                plt.figure(figsize=(10, 6))
...
class SystemMetricsTracker:
    ...
    def end_epoch(self, epoch, loss, auc=None, f1=None, rmse=None):  # Añadir RMSE
    ...
    def end_test(self, auc, f1, rmse=None):  # Añadir RMSE
        self.test_metrics = {
...
def train(args, data, show_loss, show_topk):
    ...
    test_auc_list = []
    test_f1_list = []
    train_rmse_list = []  # Nueva lista para RMSE de entrenamiento
    test_rmse_list = []   # Nueva lista para RMSE de prueba
    ...
    try:
        ...
        with tf.compat.v1.Session() as sess:
            ...
            for step in range(args.n_epochs):
                ...
                # End epoch tracking
                system_tracker.end_epoch(step, avg_loss, eval_auc, eval_f1, train_rmse)
                emissions_tracker.end_epoch(step, avg_loss, eval_auc, eval_f1, train_rmse)
                
                # Imprimir resultados incluyendo RMSE
                print('epoch %d    train auc: %.4f  f1: %.4f  rmse: %s    eval auc: %.4f  f1: %.4f    test auc: %.4f  f1: %.4f  rmse: %s'
                    % (step, train_auc, train_f1, 
            ...
            system_tracker.end_test(final_test_auc, final_test_f1, final_test_rmse)
        ...
        emissions_tracker.end_training(final_test_auc, final_test_f1, final_test_rmse)
