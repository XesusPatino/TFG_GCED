...
class SystemMetricsTracker:
    ...
    def end_epoch(self, epoch, train_rmse, valid_rmse=None, recall_5=None, recall_10=None, ndcg_5=None, ndcg_10=None):
...
def train(model, train_data, valid_data, test_data, batch_size, max_epochs, use_early_stop, early_stop_max_epoch, top_k_values=[5, 10, 20], result_path="results"):
    ...
    for epoch in range(max_epochs):
        ...
        system_tracker.end_epoch(epoch, train_rmse, valid_rmse, recall_5, recall_10, ndcg_5, ndcg_10)
        emissions_tracker.end_epoch(epoch, train_rmse, valid_rmse, recall_5, recall_10, ndcg_5, ndcg_10)
