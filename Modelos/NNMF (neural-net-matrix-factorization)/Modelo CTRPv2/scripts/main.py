...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', type=str, default='C:/Users/xpati/Documents/TFG/CTRPv2-Dataset/split/u.data.train')
    parser.add_argument('--valid', type=str, default='C:/Users/xpati/Documents/TFG/CTRPv2-Dataset/split/u.data.valid')
    parser.add_argument('--test', type=str, default='C:/Users/xpati/Documents/TFG/CTRPv2-Dataset/split/u.data.test')
    parser.add_argument('--users', type=int, default=8401)
    parser.add_argument('--movies', type=int, default=1448)
