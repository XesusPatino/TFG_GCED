...
class DyadicRegressionDataModule(LightningDataModule):
    ...
    def _check_gender_availability(self):
        ...
        try:
            ...
            try:
                ...
                elif self.dataset_name == "IMF_DOTS_2023":
                    # For IMF DOTS 2023, check the main CSV file
                    data_file = f"{self.data_dir}/dot_2023_processed.csv"
                    sample_data = pd.read_csv(data_file, nrows=1)
                    return "gender" in sample_data.columns
                else:
                    return False
    ...
    def _load_data_without_gender(self):
        ...
        try:
            ...
            # For IMF DOTS 2023, show additional info about users and items
            if self.dataset_name == "IMF_DOTS_2023":
