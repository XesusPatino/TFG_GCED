...
class EmissionsPerEpochTracker:
    def __init__(self, result_path, model_name="GHRS_Netflix"):
...
X_users = pd.read_pickle(r"C:\Users\xpati\Documents\TFG\Pruebas(Metricas)\GHRS (Graph-based hybrid recommendation system)\data1M\x_train_alpha(0.045).pkl")
...
ratings = pd.read_csv(r'C:\Users\xpati\Documents\TFG\netflix.csv')
...
emissions_tracker = EmissionsPerEpochTracker(result_path, model_name="GHRS_Netflix")
