...
# Lectura del archivo dot_2023_processed.csv
df = pd.read_csv(dataPath + 'dot_2023_processed.csv')
...
for alpha_coef in alpha_coefs:
    ...
    X_train.to_pickle(f"data1m/x_train_IMF_dot_alpha({alpha_coef}).pkl")
