...
X_users = pd.read_pickle("data1M/x_train_IMF_dot_alpha(0.001).pkl")
...
ratings = pd.read_csv(r'C:\Users\xpati\Documents\TFG\dot_2023_processed.csv')
...
emissions_tracker = EmissionsPerEpochTracker(result_path, model_name="GHRS_IMF_DOTS")
