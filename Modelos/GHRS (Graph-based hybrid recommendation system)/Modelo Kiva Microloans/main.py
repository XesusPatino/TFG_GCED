...
X_users = pd.read_pickle(r"C:\Users\xpati\Documents\TFG\Pruebas(Metricas)\GHRS (Graph-based hybrid recommendation system)\data1M\x_train_Kiva_alpha(0.001).pkl")
...
emissions_tracker = EmissionsPerEpochTracker(result_path, model_name="GHRS_Kiva")
