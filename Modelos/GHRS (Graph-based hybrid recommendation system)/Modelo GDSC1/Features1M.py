...
# Lectura del archivo gdsc1_processed.csv
df = pd.read_csv(dataPath + 'gdsc1_processed.csv')

# Filtrar solo las columnas necesarias
columns_to_use = ['user_id', 'item_id', 'rating']
...
for alpha_coef in alpha_coefs:
    ...
    X_train.to_pickle(f"data1m/x_train_gdsc1_alpha({alpha_coef}).pkl")
