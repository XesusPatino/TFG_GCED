...
X_users = pd.read_pickle("data1m/x_train_gdsc1_alpha(0.001).pkl")
...
ratings = pd.read_csv(r'C:\Users\xpati\Documents\TFG\gdsc1_processed.csv')
...
emissions_tracker = EmissionsPerEpochTracker(result_path, model_name="GDSC1")
...
# 14. Calcular tiempo total de entrenamiento
total_training_time = sum(emissions_tracker.epoch_times) if emissions_tracker.epoch_times else 0

# 15. Generar gráficos finales de emisiones vs. rendimiento
