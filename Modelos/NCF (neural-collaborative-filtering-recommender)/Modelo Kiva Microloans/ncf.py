...
# Load Kiva Microloans dataset
print("Cargando dataset Kiva Microloans...")
ratings_df = pd.read_csv('C:/Users/xpati/Documents/TFG/kiva_ml17.csv')
...
print("Primeras filas del dataset Kiva Microloans:")
...
class KivaMicroloansDataset(Dataset):
...
train_dataset = KivaMicroloansDataset(train_df)
val_dataset = KivaMicroloansDataset(val_df)
