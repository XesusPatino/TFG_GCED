...
print("Cargando dataset Netflix...")
ratings_df = pd.read_csv('C:/Users/xpati/Documents/TFG/netflix.csv')

# Renombrar columnas para mantener compatibilidad con el resto del código
# Renombrar tanto 'user_id' como 'movie_id' según las columnas reales del dataset
ratings_df = ratings_df.rename(columns={'user_id': 'userId', 'movie_id': 'movieId'})

# Display first few rows
print("Primeras filas del dataset Netflix:")
...
train_dataset = NetflixDataset(train_df)
val_dataset = NetflixDataset(val_df)
