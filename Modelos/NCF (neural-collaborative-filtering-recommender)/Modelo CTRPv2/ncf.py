...
ratings_df = pd.read_csv('C:/Users/xpati/Documents/TFG/ctrpv2_processed.csv')
...
print("Primeras filas del dataset CTRPv2:")
...
train_dataset = CTRPv2Dataset(train_df)
val_dataset = CTRPv2Dataset(val_df)
