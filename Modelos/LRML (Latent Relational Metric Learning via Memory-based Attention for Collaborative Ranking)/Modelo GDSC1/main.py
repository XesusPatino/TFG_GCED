...
# Cargar los datos de GDSC1
ratings = pd.read_csv('C:/Users/xpati/Documents/TFG/gdsc1_processed.csv')

# Verificar y mostrar información del dataset
print(f"Número de registros: {len(ratings)}")
print(f"Número de usuarios únicos: {ratings['user_id'].nunique()}")
print(f"Número de ítems únicos: {ratings['item_id'].nunique()}")
...
# Asegurarnos de manejar correctamente valores negativos si los hay
