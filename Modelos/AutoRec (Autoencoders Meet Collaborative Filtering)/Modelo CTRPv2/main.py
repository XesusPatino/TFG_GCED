...
result_path = "C:/Users/xpati/Documents/TFG/Pruebas(Metricas)/AutoRec (Autoencoders Meet Collaborative Filtering)/Modelo CTRPv2/results/"
...
ratings_file = os.path.join(path, "ctrpv2_processed.csv")
