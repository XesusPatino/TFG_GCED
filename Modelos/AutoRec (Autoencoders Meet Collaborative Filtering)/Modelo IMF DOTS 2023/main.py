...
path = f"C:/Users/xpati/Documents/TFG/"
result_path = "C:/Users/xpati/Documents/TFG/Pruebas(Metricas)/AutoRec (Autoencoders Meet Collaborative Filtering)/Modelo IMF DOTS 2023/results/"
...
ratings_file = os.path.join(path, "dot_2023_processed.csv")
...
(R, mask_R, C, train_R, train_mask_R, test_R, test_mask_R,
 ...
 num_users, num_items, num_total_ratings) = read_rating(path, train_ratio) # Pasar solo path y train_ratio
...
print(f"Dimensiones de la matriz R: {R.shape} (Usuarios: {num_users}, Ítems: {num_items})") # Mostrar dimensiones reales
