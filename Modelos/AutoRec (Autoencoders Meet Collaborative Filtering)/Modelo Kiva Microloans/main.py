...
result_path = "C:/Users/xpati/Documents/TFG/Pruebas(Metricas)/AutoRec (Autoencoders Meet Collaborative Filtering)/Modelo Kiva Microloans/results"
...
ratings_file = os.path.join(path, "kiva_ml17.csv")
